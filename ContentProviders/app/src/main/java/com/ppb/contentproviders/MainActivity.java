package com.ppb.contentproviders;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickRetrieveTitles(View view) {
        ...
        Uri allTitles = Uri.parse(
                "content://com.ppb.provider.Books/books");
        Cursor c;
        ...
        if (c.moveToFirst()) {
            do{
                ...
                Log.v("Test",c.getString(c.getColumnIndex(
                        BooksProvider._ID)) + "," + c.getString(c.getColumnIndex(
                        BooksProvider.TITLE)) + "," + c.getString(c.getColumnIndex(
                        BooksProvider.ISBN)));
            } while (c.moveToNext());
        }
    }
